...
class ShopScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final timeDetail = timeMax
        ? 'Máximo: 18 segundos por rodada'
        : 'Atual: ${10 + extraSeconds}s • Compra: +2s';
    final lifeDetail = lifeMax
        ? 'Máximo: 5 vidas por missão'
        : 'Atual: ${3 + bonusLives} vidas • Compra: +1';
            ...
            child: Column(
              ...
              children: [
                ...
                _Upgrade(
                  ...
                  detail: timeDetail,
                  price: timeCost,
                  enabled: !timeMax && coins >= timeCost,
                  onBuy: onBuyTime,
                  level: timeMax
                      ? 'MÁXIMO'
                      : 'NÍVEL $timeLevel/4',
                ...
                _Upgrade(
                  ...
                  detail: lifeDetail,
                  price: lifeCost,
                  enabled: !lifeMax && coins >= lifeCost,
                  onBuy: onBuyLife,
                  level: lifeMax
                      ? 'MÁXIMO'
                      : 'NÍVEL $bonusLives/2',
