...
class ResultScreen extends StatelessWidget {
  ...
  const ResultScreen({super.key, required this.score, required this.total, required this.onReturnHome});
          ...
          child: Center(
            child: SingleChildScrollView(
              ...
              child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                ...
                const Text('MISSÃO CONCLUÍDA', style: TextStyle(color: Color(0xFF00FFFF), fontSize: 12, letterSpacing: 3, fontWeight: FontWeight.w800)),
                const SizedBox(height: 10),
                ShaderMask(
                  shaderCallback: (bounds) => const LinearGradient(colors: [Color(0xFF00FFFF), Color(0xFF8A2BE2)]).createShader(bounds),
                  child: Text(message, textAlign: TextAlign.center, style: const TextStyle(color: Colors.white, fontSize: 32, fontWeight: FontWeight.w800)),
                ),
                ...
                Container(
                  ...
                  child: Column(children: [
                    Text('\${score}/\${total}', style: const TextStyle(color: Colors.white, fontSize: 54, fontWeight: FontWeight.w900)),
                    const SizedBox(height: 2),
                    Text('\${percentage}% de acerto', style: const TextStyle(color: Color(0xFFB8C7FF), fontSize: 16, fontWeight: FontWeight.w600)),
                    const SizedBox(height: 20),
                    Text(detail, textAlign: TextAlign.center, style: const TextStyle(color: Colors.white70, fontSize: 15, height: 1.5)),
                  ]),
                ),
