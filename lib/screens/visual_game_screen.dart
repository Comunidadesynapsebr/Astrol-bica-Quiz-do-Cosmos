          ...
          child:Padding(
            ...
            child:Column(children:[
              Row(children:[
                ...
                Text(',style:const TextStyle(color:Colors.white,fontWeight:FontWeight.w800)),
                const Spacer(),
...
+'{current+1}/'+',style:const TextStyle(color:Colors.white,fontWeight:FontWeight.w800)),
                const Spacer(),
                _Pill(Icons.favorite_rounded,'$lives'),
                const SizedBox(width:7),
                if(widget.showTimer)_Pill(Icons.timer_outlined,'$seconds'),
...
+'{rounds.length}',style:const TextStyle(color:Colors.white,fontWeight:FontWeight.w800)),
                const Spacer(),
                _Pill(Icons.favorite_rounded,'$lives'),
                const SizedBox(width:7),
                if(widget.showTimer)_Pill(Icons.timer_outlined,'$seconds'),
