...
class VisualGameScreen extends StatefulWidget {
  ...
  @override
  State<VisualGameScreen> createState() => _VisualGameScreenState();
}

class _VisualGameScreenState extends State<VisualGameScreen>
                        ...
                        for (final type in CosmicType.values)
                          Padding(
                            ...
                            child: _AnswerButton(
                              ...
                              correct: locked && type == question.answer,
                              onTap: () => _answer(type),
                            ),
                          ),
                        if (locked)
